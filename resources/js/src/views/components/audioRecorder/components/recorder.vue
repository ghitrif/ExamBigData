...
<template>
  <div class="ar">
    ...
    <div class="ar-recorder__duration" style="text-align:center">{{recordedTime}}</div>

    <div class="ar-content" :class="{'ar__blur': isUploading}">
      <div class="ar-recorder" style="    position: relative;
    display: flex;
    flex-direction: row;
    align-items: center;
    flex-wrap: nowrap;
    ...
    justify-content: center;">
        ...
        <icon-button
          ...
          name="stop"
          style="    position: unset; margin-left:10px"
          @click.native="stopRecorder"/>
      </div>

      
      <!-- <div class="ar-recorder__time-limit" v-if="time">Record duration is limited: {{time}}m</div> -->
      <audio-player v-if="recordList.length" :record="recordList[0]"/>

      <div class="ar-records" style="    width: 100%;
    height: 40px; 
    padding: 0px;
    margin: 0px;
    text-align: center;">
              ...
              <uploader
              v-if="recordList.length" :record="recordList[0]"
              class="ar__uploader"
