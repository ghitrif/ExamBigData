...
export default {
  ...
  computed:{
    nodes_(){
      var nds = this.nodes.filter(function(itm){
        return itm.type.toLowerCase() == "video" || itm.type.toLowerCase() == 'folder'
      });
      return nds
    }
  ...
  mounted () {
    ...
    console.log("🚀 ~ file: Tree.vue ~ line 108 ~ mounted ~ type", this.type)
  },
