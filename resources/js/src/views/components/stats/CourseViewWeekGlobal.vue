...
<div class="row  col-md-10" style="margin:0 auto; margin-top:40px" >
    <div class="col-lg-12 col-md-12 col-sm-12 item " v-show="loaded__">
        <div class="card item-card card-block" style="padding: 30px;">
            <div id="chart"></div>
        </div>
    </div>

    <div v-show="!loaded__" style="ext-align: center;">
...
export default {
  ...
  methods:{
    ...
    ...mapActions(["getCourseStats_global_weekly"]),
      
    async load_stats() {
        let res = await this.getCourseStats_global_weekly({ days:10})
        this.loaded__ = true
         var options_ = {
          series: [{
          name: 'Views',
