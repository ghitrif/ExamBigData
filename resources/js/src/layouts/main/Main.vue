...
<template>
  <div class="layout--main" :class="[layoutTypeClass, navbarClasses, footerClasses, {'no-scroll': isAppPage}]">
    ...
    <!-- Navbar -->
    <template v-if="mainLayoutType === 'horizontal' && windowWidth >= 1200 && $route.name != 'FunnelPreview' && $route.name != 'FunnelEmbed' && $route.name != 'LessonEmbed'">
    ...
    <template v-else-if="  $route.name != 'FunnelPreview' && $route.name != 'FunnelEmbed' && $route.name != 'LessonEmbed'">
      <the-navbar-vertical
