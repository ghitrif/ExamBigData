      ...
      <vs-navbar class="vx-navbar navbar-custom navbar-skelton" :color="navbarColor">
        ...
        <ul class="menu-items flex flex-wrap w-full items-center">
          <li
            ...
            :key   = "index"
            :class = "{'mr': !(navMenuItems.length === index+1)}">
            ...
            <!-- If it's link -->
            <div v-else-if="item.url" class="menu-link mr-5">
              <h-nav-menu-item
...
import NotificationDropDown from '../navbar/components/NotificationDropDown'
