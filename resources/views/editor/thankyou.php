...
<div class="wrapper">
				...
				<div class="col-xl-6 offset-xl-3 text-center">
					<div class="breadcrumb_content">
						<h4 class="breadcrumb_title">
                            <quill-editor v-model="settings.thankyou.topBarTitle" 
                                    ref="quillEditor"
	...
	<section class="shop-checkouts">
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-lg-8 col-xl-8" style="margin:  auto;">
					<quill-editor v-model="settings.thankyou.content" 
                                    ref="quillEditor"
                                    :options="{theme: 'bubble'}"/>	</h4>
